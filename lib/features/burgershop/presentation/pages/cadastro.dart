...
import '../../data/datasources/cidades.dart';
import '../../data/datasources/estados.dart';
import 'package:date_time_picker/date_time_picker.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

import '../widets/dot_indicator.dart';
...
//                                      : null,
                                    ...
                                    return DropdownButtonFormField(
                                      ...
                                      onChanged: (value) {
                                        _estadoController.text =
                                            value.toString();
                                        setState(() {
                                          cidades = CadastroBloc().buscaCidades(_estadoController.text);
                                        });
                                      },
                                      validator: (value) {
                                        if (value == null) {
  ...
  _validate(nome, cpf, data, estado, cidade) {
    if (nome.isNotEmpty && cpf.isNotEmpty && data.isNotEmpty
